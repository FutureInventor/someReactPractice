...
.ant-click-animating-node {
  ...
  -webkit-box-shadow: 0 0 0 0 #64B2CB;
          box-shadow: 0 0 0 0 #64B2CB;
...
@-webkit-keyframes waveEffect {
  100% {
    -webkit-box-shadow: 0 0 0 #64B2CB;
            box-shadow: 0 0 0 #64B2CB;
...
.ant-menu-submenu-inline > .ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before {
  background: -webkit-gradient(linear, left top, right top, from(#64B2CB), to(#64B2CB));
  background: linear-gradient(to right, #64B2CB, #64B2CB);
}
.ant-menu-submenu-vertical > .ant-menu-submenu-title .ant-menu-submenu-arrow::before,
.ant-menu-submenu-vertical-left > .ant-menu-submenu-title .ant-menu-submenu-arrow::before,
.ant-menu-submenu-vertical-right > .ant-menu-submenu-title .ant-menu-submenu-arrow::before {
...
.ant-menu-horizontal:not(.ant-menu-dark) > .ant-menu-submenu-selected {
  color: #64B2CB;
  border-bottom: 2px solid #64B2CB;
}
.ant-menu-horizontal > .ant-menu-item,
.ant-menu-horizontal > .ant-menu-submenu {
  position: relative;
...
.ant-upload-list-picture .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#64B2CB'],
.ant-upload-list-picture-card .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#64B2CB'] {
  fill: #ff4d4f;
}
